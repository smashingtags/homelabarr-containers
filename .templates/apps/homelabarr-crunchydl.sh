...
APPBRANCH="master"
APPLINK="https://github.com/anidl/multi-downloader-nx/releases"
NEWVERSION=$(curl -u $USERNAME:TOKEN -sX GET https://api.github.com/repos/smashingtags/multi-downloader-nx/releases/latest | jq --raw-output '. | .tag_name')
...
#docker pull ghcr.io/smashingtags/homelabarr-crunchydl:latest 

### FOR LOGIN ###
#  docker run -it --rm \
#    --name crunchy \
#    -v /opt/appdata/crunchy:/config:rw \
#    ghcr.io/smashingtags/homelabarr-crunchydl:latest \

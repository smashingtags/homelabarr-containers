...
## BRAND VERSION
APPVERSION=$(curl -u $USERNAME:$TOKEN -sX GET "https://api.github.com/repos/smashingtags/homelabarr-cli/releases/latest" | awk '/tag_name/{print $4;exit}' FS='[""]' | sed -e 's_^v__')
...
PACKAGES="bash git"
PULLWIKI="mkdir -p /app && git clone --quiet https://github.com/smashingtags/homelabarr-cli.git /app"
